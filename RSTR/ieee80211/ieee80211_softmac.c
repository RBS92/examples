...
#define RTL8187_MODULE_NAME "MG MAC"
	...
	struct ieee80211_device *ieee, int challengelen)
{
	...
	skb = dev_alloc_skb(sizeof(struct ieee80211_authentication) + challengelen + 8); 
...
void ieee80211_softmac_xmit(struct ieee80211_txb *txb, struct ieee80211_device *ieee)
{
	...
	exit:
	atomic_dec(&ieee->tx_pending_txb); //R //TBD //ERROR THIS IS THE FUCKING ERROROUNOUS PIECE OF SHIT CODE
	spin_unlock_irqrestore(&ieee->lock,flags);
...
void ieee80211_start_protocol(struct ieee80211_device *ieee)
{
	...
	DMESG("Current channel is: %i", ieee->current_network.channel);
